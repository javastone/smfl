...
int main()
{
    ...
    while (gameWindow.isOpen())
    {
       ...
       // Timer display positions
        float minutesStartX = numColumns * 32 - 100; // Starting X position for minutes
        float secondsStartX = numColumns * 32 - 57; // Starting X position for seconds
        float timerY = (numRows + 0.5) * 32 + 10;   // Y position for the timer
