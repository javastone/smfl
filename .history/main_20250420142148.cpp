...
int main() {
    ...
    while (gameWindow.isOpen()) {
        ...
        // Draw elapsed time (minutes and seconds)
        sf::RectangleShape timeBackground(sf::Vector2f(100, 50));
        timeBackground.setFillColor(sf::Color(200, 200, 200, 150));
        ...
        timeText.setString("Time: " + to_string(elapsed.first) + "m " + to_string(elapsed.second) + "s");
        timeText.setPosition(15, (numRows + 0.5) * 32 + 10);
