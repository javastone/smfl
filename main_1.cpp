...
int main___1()
{
	...
	//SFML window
	sf::RenderWindow window(sf::VideoMode(CELL_SIZE * COLUMNS ,  CELL_SIZE * ROWS +100), "Minesweeper", sf::Style::Close);
	...
	if(!Alexander_texture.loadFromFile("files\\Images\\Alexander.png")){
		std::cout << "err loading font texture  111 444" << std::endl;
	};
